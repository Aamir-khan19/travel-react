const packageData = [
  ...
  },
  {
    ...
    description:
      "Madhya Pradesh is known for its historical monuments, wildlife, and vibrant culture.",
    title2:
      "Madhya Pradesh, located in central India, is known for its rich history, stunning monuments, and diverse wildlife. The state is home to numerous UNESCO World Heritage Sites, including Khajuraho's temples and the forts of Gwalior and Mandu. Madhya Pradesh's national parks, such as Kanha and Bandhavgarh, are famous for their tiger populations and scenic landscapes. The state's vibrant culture is reflected in its festivals, traditional crafts, and delicious cuisine, making it a fascinating destination for history and nature enthusiasts.",
  ...
  },
  {
    ...
    title: "Nagaland",
    description:
      "Nagaland is known for its vibrant culture, festivals, and stunning landscapes.",
    title2:
