  ...
  return (
    <>
      ...
      <div className="p-5">
        ...
        {tripData?.content?.map((content) => (
          <div key={content.heading} className="bg-white border border-gray-200 mb-8 rounded-lg shadow-lg p-6 flex flex-col md:flex-row md:justify-between">
            <div className="md:w-1/2 flex flex-col items-center md:items-start">
              ...
              <img
                src={content?.image || "https://images.pexels.com/photos/63638/roses-flower-nature-macro-63638.jpeg?cs=srgb&dl=bloom-blossom-flora-63638.jpg&fm=jpg"}
                className="w-[80%] object-cover rounded-md mb-4"
                alt={content.heading} // Added alt text for accessibility
              />
            </div>
            ...
            <div className="md:w-1/2 flex flex-col justify-between p-4 rounded-md mt-10">
              ...
              {/* Enquiry Button */}
              <a href="#enquiry_form">
              <button className="bg-blue-600 w-full text-white font-semibold py-2 rounded-md hover:bg-blue-700 transition duration-200">
                Enquire Now
              </button>
              </a>
        ...
        <div id='enquiry_form' className="bg-white border border-gray-200 p-8 rounded-lg shadow-2xl mt-10 md:mx-auto md:w-[60%] transition-all duration-300 transform hover:scale-105">
...
{/* Enquiry form ends here  */}
        ...
        <div className="mt-8">
          ...
          <div ref={sliderContainerRef} className="keen-slider">
            ...
            <div key={i} className="keen-slider__slide bg-white border border-gray-200 rounded-lg shadow-lg p-4">
           
            <h4 className="text-xl font-semibold text-gray-800 mb-2">{trip?.mainHeading}</h4>
            <img src={trip?.mainImage} alt={`Slide ${i+1}`} className="w-full object-cover" />
              <p className="text-gray-600 mb-4 text-center mt-2">{trip?.text}</p>

              <Link to={`/trip-ideas/${trip?.to}/${trip?.id}`} className="text-blue-600 mt-5 hover:underline">Read More</Link>
